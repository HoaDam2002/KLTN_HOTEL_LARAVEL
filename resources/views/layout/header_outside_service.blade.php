    ...
    <div class="mobile-menu__inner">
        ...
        <div class="mobile-menu__menu">
            <ul class="nav-menu flx-align nav-menu--mobile">
                ...
                <li class="nav-menu__item">
                    <a href="/outside_service/manation" class="nav-menu__link">{{ __('Service Manation') }}</a>
                </li>
                <li class="nav-menu__item">
                    <a href="/outside_service/order" class="nav-menu__link">{{ __('Order Service') }}</a>
                </li>
                <li class="nav-menu__item">
        ...
        <div class="flx-between">
            <div class="header-info flx-align">
                ...
                <div class="header-info__item flx-align">
                    ...
                    <a href="tel:" class="header-info__text">03949037209</a>
                </div>
                <div class="header-info__item flx-align">
