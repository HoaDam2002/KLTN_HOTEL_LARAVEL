...
@section('content')
<form class="row g-3 col-9">
  <div class="col-md-4">
    <label for="validationServer01" class="form-label">Name</label>
    <input type="text" class="form-control ">
  </div>
  <div class="col-md-4">
    <label for="validationServer02" class="form-label">Tel</label>
    <input type="text" class="form-control">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">LIST USER ACCOUNT</h5>
                ...
                <div class="modal-footer mt-5">
                  <div class="container text-center">
                    ...
                    <button type="button" class="btn btn-primary" style="margin-left: 30px;">Save</button>
                  </div>
                </div>
              </div>
            </div>
