                ...
                <div class="container container-two">
                    <nav class="header-inner flx-between">
                        ...
                        <div class="header-menu d-lg-block d-none">
                            ...
                            <h3 style="padding: 15px; margin: 0">{{__("Room Status Management")}}</h3>
                        </div>
                        <!-- Menu End  -->
                        ...
                        <div class="header-right flx-align">
                            @if (Auth::check())
                                {{-- <button class="btn d-lg-block d-none"> --}}
                                    ...
                                    {{-- <a href="/logout" class="account-icon-link"><i
                        ...
                        {{-- <div class="col-xl-3 col-lg-4">
                            <div class="account-sidebar search-sidebar">
                                <div class="nav side-tab flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                    ...
                                    <a href="/recep/request-booking"
                                        class="nav-link {{ Route::currentRouteName() == 'request-booking-recep' ? 'active' : '' }}"
