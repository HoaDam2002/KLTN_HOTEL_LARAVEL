                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="property-item style-two">
                            ...
                            <div class="property-item__content">
                                <h6 class="property-item__title">
                                    <a href="property-details.html" class="link"> Your journey homeownership starts
                                        here too </a>
                                </h6>
                                <ul class="amenities-list flx-align">
                                    <li class="amenities-list__item flx-align">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="property-item style-two">
                            ...
                            <div class="property-item__content">
                                <h6 class="property-item__title">
                                    <a href="property-details.html" class="link"> Brick by Brick Your Dream Home
                                        Awaits </a>
                                </h6>
                                <ul class="amenities-list flx-align">
                                    <li class="amenities-list__item flx-align">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="property-item style-two">
                            ...
                            <div class="property-item__content">
                                <h6 class="property-item__title">
                                    <a href="property-details.html" class="link"> Home is Where Your Story Begins
                                    </a>
                                </h6>
                                <ul class="amenities-list flx-align">
                                    <li class="amenities-list__item flx-align">
