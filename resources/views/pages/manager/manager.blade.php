        ...
        <main class="body-bg">
            ...
            <div class="mobile-menu d-lg-none d-block">
                ...
                <div class="mobile-menu__inner">
                    @if (Auth::check())
                        <a href="/manager/home" class="mobile-menu__logo">
                    ...
                    <div class="flx-between">
                        <div class="header-info flx-align">
                            <div class="language-switcher" id="vi-flag">
                                <button class="flag-button"><img src="{{ asset('assets/customer/images/lang/flag_vi.jpg') }}" /></button>
                            ...
                            <div class="language-switcher active" id="en-flag">
                                <button class="flag-button"><img src="{{ asset('assets/customer/images/lang/flag_en.jpg') }}" /></button>
            ...
            <header class="header" style="position: relative">
                <div class="container container-two">
                    <nav class="header-inner flx-between">
                        <!-- Logo Start -->
                        <div class="logo">
                            <a href="/manager/home" class="link" style="width: 190px; height: 100%; object-fit: contain">
                        ...
                        <div class="col-xl-3 col-lg-4">
                            <div class="account-sidebar search-sidebar">
                                <div class="nav side-tab flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                    ...
                                    <a href="/manager/home"
                                        class="nav-link {{ Route::currentRouteName() == 'home_manager' ? 'active' : '' }}">
