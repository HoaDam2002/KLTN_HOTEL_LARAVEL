    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="loginRegister__title text-poppins mb-0 title_edit">{{__("Edit Food")}}</h4>
            ...
            <div class="modal-body">
                <form id="form_edit" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row gy-lg-4 gy-3">
                        <div class="col-12">
                            <label for="Food Name" class="form-label">{{__("Name")}}</label>
                            <input type="text" class="common-input" placeholder="{{__("Name")}}" id="foodname" name="name" required>
                        </div>

                        <div class="col-12">
                            <label for="price" class="form-label">{{__("Price")}}</label>
                            <input type="number" class="common-input" placeholder="{{__("Price")}}" id="price" name="price" required>
                        </div>
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-main w-100 btn_update_food">{{__("Update")}} <span class="icon-right"> <i
