            ...
            <header class="header" style="position: relative">
                <div class="container container-two">
                    <nav class="header-inner flx-between">
                        <!-- Logo Start -->
                        <div class="logo">
                            <a href="/food_service" class="link" style="width: 190px; height: 100%; object-fit: contain">
                        ...
                        <div class="header-menu d-lg-block d-none">
                            ...
                            <h3 style="padding: 15px; margin: 0">{{__("Restaurant department")}}</h3>
                        </div>
                        <!-- Menu End  -->
                        ...
                        <div class="col-xl-3 col-lg-4">
                            <div class="account-sidebar search-sidebar">
                                <div class="nav side-tab flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                    ...
                                    <a href="/food_service"
                                        class="nav-link {{ Route::currentRouteName() == 'home_food_service' ? 'active' : '' }}"
